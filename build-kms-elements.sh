...
CMAKE_CXX_FLAGS=" -I$KMS_JSONCPP_DIR/include/ -I$OPENWEBRTC_GST_PLUGINS_DIR/gst-libs/ -L$OPENWEBRTC_GST_PLUGINS_DIR/gst-libs/gst/sctp/.libs/ -L$OPENWEBRTC_GST_PLUGINS_DIR/gst/videorepair/.libs"
