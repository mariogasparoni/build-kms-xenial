...
#DEBUG
#env LD_LIBRARY_PATH=$LIBRARY_PATH GST_PLUGIN_PATH=$GST_PLUGIN_PATH GST_DEBUG=$DEBUG_LEVEL gdb -ex run --args ./kurento-media-server -f $KMS_CONFIG_FILE -p $MODULES_DIR -c $MODULES_CONFIG_DIR
